...
const fileIconsMap = {
  ...
  apk: (darkMode = false) => `
    <svg xmlns="http://www.w3.org/2000/svg" class="w-full h-full" viewBox="0 0 24 24" fill="none">
      <!-- Document base -->
      <path d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2Z" fill="#3DDC84"/>
      <path d="M14 2V8H20" fill="rgba(0,0,0,0.1)"/>
      <!-- Android robot head -->
      <rect x="8" y="12" width="8" height="6" rx="1" fill="white"/>
      <!-- Eyes -->
      <circle cx="10" cy="14" r="0.8" fill="#3DDC84"/>
      <circle cx="14" cy="14" r="0.8" fill="#3DDC84"/>
      <!-- Antennas -->
      <path d="M9.5 11L8.5 9.5" stroke="white" stroke-width="1.2" stroke-linecap="round"/>
      <path d="M14.5 11L15.5 9.5" stroke="white" stroke-width="1.2" stroke-linecap="round"/>
    </svg>
  `,
