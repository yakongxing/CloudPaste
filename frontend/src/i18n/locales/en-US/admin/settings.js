export default {
  ...
  preview: {
    ...
    previewProvidersPlaceholder:
      "Use JSON array rules to define match conditions, preview type, and URL templates (supports $preview_url/$download_url/$name and encoded $e_* tokens).",
    ...
    ruleProviderUrlPlaceholder: "URL template(supports $url/$preview_url/$download_url/$name; native = local/native preview; but iframe must be a real URL)",
    addRule: "Add rule",
    removeRule: "Remove",
