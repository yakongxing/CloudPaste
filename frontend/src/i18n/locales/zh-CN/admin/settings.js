export default {
  ...
  preview: {
    ...
    previewProvidersPlaceholder:
      "使用 JSON 数组定义匹配条件、预览类型与 URL 模板（支持 $preview_url/$download_url/$name，以及对应的 $e_* 编码版）。",
    ...
    ruleProviderUrlPlaceholder: "URL 模板（支持 $url/$preview_url/$download_url/$name；native=本地/原生；但 iframe 这里必须是真实 URL）",
    addRule: "添加规则",
    removeRule: "删除",
    addProvider: "添加预览器",
    removeProvider: "移除",
